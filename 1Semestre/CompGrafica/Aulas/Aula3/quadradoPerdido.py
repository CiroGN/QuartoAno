...
def main(): 
    ...
    janela = glfw.create_window(1920, 1080, "Aprendendo OpenGL 3D", None, None) 
    if not janela: 
        glfw.terminate() 
        return 
    ...
    while not glfw.window_should_close(janela): 
        ...
        glTranslatef(0, 0, -9)  # testar com -51 
        ...
        glTranslatef(0, 0, 3)  # testar com -51 
        glRotatef(glfw.get_time() * 180, 1, 1, 0) 
